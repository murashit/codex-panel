...
import type { ThreadStreamTextActionTargets } from "../../../../../src/features/chat/presentation/thread-stream/text-view";
import { type ThreadStreamViewBlock, threadStreamViewBlocks } from "../../../../../src/features/chat/presentation/thread-stream/view-model";
import type {
...
export function threadStreamBlocks(context: TestThreadStreamContext): [ThreadStreamViewBlock, ...ThreadStreamViewBlock[]] {
