...
- Edit documentation to serve its audience and purpose. Identify the missing or inaccurate guidance and the reader decision or task it affects before changing the document. A behavior being durable or newly fixed is not sufficient reason to document it. Apply the same necessity test during review, alongside accuracy and consistency.
